$(document).ready(function(){
    "use strict";
    var tablice = ["korisnik","stranica"];

    $.ajax({
        url: "src/crud/korisnik_stranica.php",
        type: "POST",
        data:{
            tablica : tablice,
            aktivna_stranica : 0,
    ...
    function search(akcija){
        var prikaz_searcha = "<form method='post' action='src/crud/korisnik_stranica.php' id='pretraga' enctype='application/x-www-form-urlencoded'>";
    ...
    function nacrtaj_tablicu(data) {
        ...
        $.each(data.podaci, function (index, vrijednost) {
            ...
            prikaz_tablice += "<tr>";
            prikaz_tablice += "<td>"+ vrijednost.stranica +"</td>";
