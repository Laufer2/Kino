$(document).ready( function(){
    ...
    function search(akcija){
        var prikaz_searcha = "<form method='post' action='src/crud/slika.php' id='pretraga' enctype='application/x-www-form-urlencoded'>";
    ...
    function nacrtaj_tablicu(data) {
        ...
        $.each(data.podaci, function (index, slika) {

            prikaz_tablice += "<tr>";
            prikaz_tablice += "<td>"+ slika.korisnik +"</td>";
